...
cd projeto_09_analise_desempenho_escolar
...
git commit -m "Initial commit: Sistema de Análise de Desempenho Escolar"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_09_analise_desempenho_escolar`
   - **Description**: "Sistema de Análise de Desempenho Escolar - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_09_analise_desempenho_escolar.git
...
```
projeto_09_analise_desempenho_escolar/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_escolar.py      # Código principal
