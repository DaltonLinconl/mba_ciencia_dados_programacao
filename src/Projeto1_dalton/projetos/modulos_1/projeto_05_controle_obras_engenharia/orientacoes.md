...
cd projeto_05_controle_obras_engenharia
...
git commit -m "Initial commit: Sistema de Controle de Obras de Engenharia"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_05_controle_obras_engenharia`
   - **Description**: "Sistema de Controle de Obras de Engenharia - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_05_controle_obras_engenharia.git
...
```
projeto_05_controle_obras_engenharia/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_obras.py      # Código principal
