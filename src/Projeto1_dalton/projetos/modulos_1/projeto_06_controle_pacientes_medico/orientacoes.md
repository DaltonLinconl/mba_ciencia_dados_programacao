...
cd projeto_06_controle_pacientes_medico
...
git commit -m "Initial commit: Sistema de Controle de Pacientes"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_06_controle_pacientes_medico`
   - **Description**: "Sistema de Controle de Pacientes - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_06_controle_pacientes_medico.git
...
```
projeto_06_controle_pacientes_medico/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_pacientes.py      # Código principal
