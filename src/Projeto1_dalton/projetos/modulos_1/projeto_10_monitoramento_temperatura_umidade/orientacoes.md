...
cd projeto_10_monitoramento_temperatura_umidade
...
git commit -m "Initial commit: Sistema de Monitoramento de Temperatura e Umidade"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_10_monitoramento_temperatura_umidade`
   - **Description**: "Sistema de Monitoramento de Temperatura e Umidade - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_10_monitoramento_temperatura_umidade.git
...
```
projeto_10_monitoramento_temperatura_umidade/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_monitoramento.py      # Código principal
