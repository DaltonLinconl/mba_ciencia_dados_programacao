...
cd projeto_07_monitoramento_seguranca_publica
...
git commit -m "Initial commit: Sistema de Monitoramento de Segurança Pública"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_07_monitoramento_seguranca_publica`
   - **Description**: "Sistema de Monitoramento de Segurança Pública - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_07_monitoramento_seguranca_publica.git
...
```
projeto_07_monitoramento_seguranca_publica/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_seguranca.py      # Código principal
