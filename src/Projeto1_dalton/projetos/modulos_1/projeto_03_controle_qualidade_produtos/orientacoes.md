...
cd projeto_03_controle_qualidade_produtos
...
git commit -m "Initial commit: Sistema de Controle de Qualidade de Produtos"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_03_controle_qualidade_produtos`
   - **Description**: "Sistema de Controle de Qualidade de Produtos - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_03_controle_qualidade_produtos.git
...
```
projeto_03_controle_qualidade_produtos/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_qualidade.py      # Código principal
